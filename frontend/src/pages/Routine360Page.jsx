...
export default function Routine360Page() {
  ...
  const [step, setStep] = useState(1); // Connexion désactivée temporairement : on démarre directement à l'étape 1 (0 = auth, 1 = type, 2 = subtype (visage), 2.5 = cat-questions, 3 = products, 5 = recap)
  ...
  if (false && !user) { // Connexion désactivée temporairement (à réactiver plus tard : remettre juste "if (!user) {")
    return (
